...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Agu 2022 pada 08.55
...
(1, 'keyboard', 'warna pink', 'elektronik', 'dus'),
...
CREATE TABLE `peminjam` (
  ...
  `nm_peminjam` varchar(60) NOT NULL,
  `telp_peminjam` char(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `pengembalian` (
  ...
  `jumlah_dikembalikan` varchar(20) NOT NULL,
  `tanggal_pinjam` date NOT NULL,
  `tanggal_kembali` date NOT NULL,
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `peminjaman_ibfk_1` FOREIGN KEY (`id_peminjaman`) REFERENCES `peminjam` (`id_peminjam`);
